...
public class EnchantmentsComponentImpl implements EnchantmentsComponent {
    ...
    public static class Type implements DataComponentType<EnchantmentsComponent>, Factory {

        public static Type INSTANCE = new Type();

        @Override
        public EnchantmentsComponent create(Map<EnchantmentHolder<Integer>, Integer> enchantments) {
            return new EnchantmentsComponentImpl(enchantments, true);
        }

        @Override
        public EnchantmentsComponent create(Map<EnchantmentHolder<Integer>, Integer> enchantments, boolean showInTooltip) {
